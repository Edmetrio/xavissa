                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-custom">
                                                                <div class="single-input-item mb-3">
                                                                    <label for="first-name" class="required mb-1">Nome da Categoria</label>
                                                                    <input type="text" id="nome" name="nome" value="{{$categoria->nome}}" placeholder="Nome da Categoria" />
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-custom">
                                                                <div class="single-input-item mb-3">
                                                                    <label for="Icon" class="required mb-1">Icon</label>
                                                                    <input type="text" id="icon" name="icon" value="{{$categoria->icon}}" placeholder="banana.png" /><br>
                                                                </div>
