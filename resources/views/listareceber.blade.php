                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>${{$p->valor}},00</td>
                            <td>{{$p->recebimento}}</td>
                            <td><a class="prd-wshlst-btn" href={{"receber/$p->id/edit"}} title="Alterar"><i class="fa fa-pencil edit-btn"></i></a>
                                <a class="prd-adcrt-btn" href={{"rdestroy/$p->id"}} title="Apagar"><i class="fa fa-trash-o"></i></a>
                            </td>
                            
                            @if($p->estado_id == 2)<td><span class="lmtd">{{$p->contnome}}</span></td> @else <td><span class="avabl">{{$p->contnome}}</span></td>@endif
