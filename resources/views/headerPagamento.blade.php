...
<head>
    ...
    <!-- Script Sislog para Pagamento via visa -->
    <script type="text/javascript" src="https://lin4.sislog.com/mobile/c2b_visa/bim_mastercard.js">
    </script>
    <script src="https://millenniumbim.gateway.mastercard.com/checkout/version/58/checkout.js" 
    data-error="erroreCallback" data-cancel="cancelCallback" data-complete="completeCallback">
    </script>
