                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2 col-xl-2 col-sm-6 col-6 col-custom">
                            <div class="header-logo d-flex align-items-center">
                                <a href="{{url('/')}}">
                                    <img class="img-full" src="{{asset('assets/images/logo/logo.png')}}" alt="First Tech">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-8 col-xl-7 position-static d-none d-lg-block col-custom">
                            <nav class="main-nav d-flex justify-content-center">
                                <ul class="nav">
                                    ...
                                    <li>
                                        <a class="active" href="{{url('produto')}}">
                                    ...
                                    <li class="minicart-wrap">
                                        ...
                                        <div class="cart-item-wrapper dropdown-sidemenu dropdown-hover-2">
                                            ...
                                            <div class="single-cart-item">
                                                <div class="cart-img">
                                                    <a href="cart.html"><img src="{{asset('assets/images/product/'.$i->icon)}}" alt=""></a>
                                                </div>
                                                <div class="cart-text">
                ...
                <div class="row">
                    <div class="col-12 text-center col-custom">
                        <div class="copyright-content">
                            <p>Copyright © 2021 <a href="https://firsteducation.edu.mz/" title="https://firsteducation.edu.mz/">First Tec</a> | Feito Pela&nbsp;<strong>firstec</strong>&nbsp;by <a href="https://firsteducation.edu.mz/" title="https://firsteducation.edu.mz/">firstec</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="top-info-wrap text-left text-black">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="info%40yourdomain.html">info@agro.co.mz</a>
                            </li>
                        </ul>
                    </div>
